    ...
    var featureDefinitions: [FeatureDefinition] {
        [
            FeatureDefinition(
                ...
                group: .tilingLayout,
                title: "Float Windows on This Desktop",
            ...
            FeatureDefinition(
                ...
                group: .tilingLayout,
                title: "Tile Windows on This Desktop",
                description: "Puts the windows on this desktop back into tiles and evens out their sizes.",
                backend: .tilePilotAction,
                capabilityGate: .yabaiRuntime,
            ...
            FeatureDefinition(
                ...
                description: "Raises floating windows above the other windows on the current desktop.",
                backend: .tilePilotAction,
                capabilityGate: .yabaiRuntime,
                defaultCombo: nil,
                commandMatchers: [
            ...
            FeatureDefinition(
                ...
                group: .tilingLayout,
                title: "Arrange Windows in Floating Grid",
                description: "Places the windows on this desktop into a simple row-and-column grid and leaves them floating.",
                backend: .tilePilotAction,
                capabilityGate: .yabaiRuntime,
            ...
            FeatureDefinition(
                ...
                group: .tilingLayout,
                title: "Retile and Rebalance Windows",
                description: "Retiles the windows on this desktop and rebuilds them into a more even layout.",
                backend: .tilePilotAction,
                capabilityGate: .yabaiRuntime,
            ...
            FeatureDefinition(
                ...
                description: "Turns tiling on for the current desktop and evens out tile sizes.",
                backend: .shortcutCommand,
                capabilityGate: .yabaiRuntime,
            ...
            FeatureDefinition(
                ...
                description: "Redistributes space so tiled windows on the current desktop are closer in size.",
                backend: .shortcutCommand,
                capabilityGate: .yabaiRuntime,
                defaultCombo: "alt - 0",
